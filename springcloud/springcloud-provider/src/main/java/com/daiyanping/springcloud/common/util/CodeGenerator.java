package com.daiyanping.springcloud.common.util;
...
//    private final static String MODULE_NAME = "test";
    ...
    private final static String PROJECT_PATH = "D:/git-repository/gitskills/springcloud/springcloud-provider";

    private final static String MODULE_NAME = "provider";

    private final static String PARTENT_PATH = "com.daiyanping.springcloud";

    private final static String DATABASE_URL = "jdbc:mysql://192.168.140.128:3306/test";

    private final static String USERNAME = "root";

    private final static String PASSWORD = "test1234";

    private final static String MAPPERXML_PATH = "/src/main/resources/sqlMapperXml/provider/";
...
//        strategy.setExclude(new String[]{"test"});
        // 设置实体类的父类 默认Model
        strategy.setSuperEntityClass("com.daiyanping.springcloud.common.base.SuperEntity");
        ...
        // 自定义 controller 父类
        strategy.setSuperControllerClass("com.daiyanping.springcloud.common.base.BaseController");
