...
public class AspectAnnotation {
    ...
    * */
    @DeclareParents(value = "com.daiyanping.cms.spring.service1.BankServiceImpl",
            defaultImpl = com.daiyanping.cms.spring.service.DataCheckImpl.class)
    private DataCheck dataCheck;

    @Pointcut("execution(public * com.daiyanping.cms.spring.service.*.*(..))")
    public void pc1(){}

    @Pointcut("execution(public * com.daiyanping.cms.spring.service.*.add*(..))")
    public void pc2(){}

    @Pointcut("execution(public * com.daiyanping.cms.spring.service1.*.*(..))")
    public void pc3(){}
